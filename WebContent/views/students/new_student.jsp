...
<%--      <h3>${pageContext.request }</h3> --%>
        ...
        <div class="col_4 inputBox">
            ...
            <form action="${pageContext.request.contextPath}/students/new" class="inputfields">
                <input class="textbox" type="text" name="name" size="30" placeholder="Name Of Student">
                <input class="textbox" type="text" name="address" size="30" placeholder="Address">
                <input class="textbox" type="text" name="course" size="30" placeholder="Course">
                
                 <!--Start of Buttons -->
    <div class="row">
        <div class="col_4"></div>
        <div class="col_4 button-container">
            <button class="button button1" type="submit" name="action" value="Add">ADD</button>
